...
class Book(BaseModel):
    ...
    lenguage = models.CharField(
        ...
        blank=False,
        null=False,
        choices=Lenguages.choices,
        default=Lenguages.english,
    ...
    discount_start_date = models.DateTimeField(
        blank=True, null=True, help_text="Fecha de inicio del descuento"
    )
...
class CategoryBook(BaseModel):
    book = models.ForeignKey(
        Book, related_name="category_book", on_delete=models.CASCADE
    )
