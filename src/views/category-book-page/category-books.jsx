...
export const CategoryBooks = () => {
  return (
    <>
      <section className="container mx-auto bg-[hsl(271,46%,77%)] bg-opacity-55 w-full h-full rounded-xl mt-20 shadow-lg flex flex-col items-center justify-center">
