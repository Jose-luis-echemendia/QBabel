...
export const BuyBook = () => {
  ...
  return (
    <div className="flex justify-center items-center h-full">
      <div className="w-[30rem] h-[45rem] max-w-[90vw] max-h-[90vh] flex">
        <Card className="w-full h-full flex flex-col overflow-hidden">
          <CardHeader
            color="gray"
            floated={false}
            shadow={false}
            className="m-0 grid place-items-center px-4 py-8 text-center h-[20rem]"
          >
            ...
            <Tabs value={type} className=" h-full flex flex-col px-4">
              ...
              >
                ...
                <TabPanel value="paypal" className="p-4 h-full">
                  <form className="flex flex-col gap-4 h-full -mb-[23px]">
