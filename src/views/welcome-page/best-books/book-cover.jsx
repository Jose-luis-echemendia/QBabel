...
export const BookCover = ({ transitionBookData, currentBookData }) => {
  return (
    <>
      <figure className="ml-10 relative object-contain mt-0">
        {transitionBookData && (
          <motion.img
            ...
            className="absolute w-full h-[90vh] rounded-2xl brightness-75 z-10"
        ...
        <motion.img
          ...
          className="absolute w-full h-[90vh] rounded-2xl backdrop-brightness-75"
        />
      </figure>
    </>
  );
